  ...
  return (
    ...
    <div className="container py-5" style={{background:"rgb(10, 1, 3)",maxWidth:"100%"}}>
        <div className="row">
            ...
            <a  aria-current="page"  to="/" style={{ color: "white", fontWeight: "900", fontSize: "20px",cursor:"pointer" }}>PayJob &nbsp; <span style={{ borderRight: "2px solid rgb(107, 114, 128)" }}></span>&nbsp;<span className='p2' style={{ color: "white", fontWeight: "500", fontSize: "0.85rem" }}>Copyright © 2022 CodeWithAashu.com</span>
            </a>
            </div>
